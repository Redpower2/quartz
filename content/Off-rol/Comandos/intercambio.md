3 parametros, como siempre.
Id, alias y user.
Luego le mandaría una solicitud con un embed con 2 botones, que es básicamente 
"X Personaje te mandó una solicitud de intercambio <@personaje2.userID>, ¿Deseas iniciar el intercambio?"
Botón rojo ✖️
Botón verde ✔️
![[Pasted image 20260510130722.png]]
...
Una vez que pasa eso, se pone o el nombre de la cosa o un emoji correspondiente. Una estrella para los items, dinero para dinero, depende de cuál se vea más linda.

Si presionas un botón por segunda vez, lo sacás de la oferta.
