Aún con lo de [[Como es el rol]], no nos basta con la teoría, tenemos que pensar como vamos a ponerlo en práctica. Porque tampoco hay un mapa de Nueva Castilla ni nada, no estoy seguro de como va a ser o como debería ser. Sabemos que es una isla, osea, costa tiene. También tiene ciudad. Así que con eso debería pensar otros lugares tipo no se, vice city, islas reales, no se.
